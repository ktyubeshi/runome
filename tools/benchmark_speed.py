#!/usr/bin/env python3
"""
Benchmark Runome against Janome and report relative speed.

This script tokenizes the same text repeatedly with both Runome and Janome,
measures wall-clock time, and prints the throughput ratio.
"""
...
def main() -> int:
    ...
    # Warmup to stabilize caches and JIT effects
    if args.warmup > 0:
